...
class TestROIAlignFine2D(unittest.TestCase):
    ...
    #     y_cpu = functions.roi_align_fine_2d(
    ...
    #     y_gpu = functions.roi_align_fine_2d(
    ...
    def check_backward(self, x_data, roi_data, y_grad):
        gradient_check.check_backward(
            functions.ROIAlignFine2D(outh=self.outh,
                                     outw=self.outw,
                                     spatial_scale=self.spatial_scale),
